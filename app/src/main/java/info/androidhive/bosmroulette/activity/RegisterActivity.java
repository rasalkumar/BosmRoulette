...
public class RegisterActivity extends Activity {
    ...
    private EditText p_hone;
    private EditText c_ollege;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        p_hone=(EditText)findViewById(R.id.phone);
        c_ollege=(EditText)findViewById(R.id.college);
		...
		btnRegister.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
                ...
                String college= c_ollege.getText().toString();

				if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !cpassword.isEmpty() && !phone.isEmpty() && !college.isEmpty()) {
					if(password.contentEquals(cpassword))
                    registerUser(name, email, password,phone,college);
                    else
                    {
	...
	private void registerUser(final String name, final String email,
			final String password,final String phone,final String college) {
		...
		StringRequest strReq = new StringRequest(Method.POST,
				AppConfig.URL_REGISTER, new Response.Listener<String>() {
						...
						try {
							...
							if (!error) {
								...
								// Now store the user in sqlite
									Toast.makeText(getApplicationContext(),
											"We have sent an activation mail to your account.", Toast.LENGTH_LONG).show();
					...
					public void onErrorResponse(VolleyError error) {
						...
						Toast.makeText(getApplicationContext(),
								"Connection Error. Please Try Later.", Toast.LENGTH_LONG).show();
						hideDialog();
					}
				}) {
			...
			protected Map<String, String> getParams() {
                ...
                params.put("rcode",rcode.getText().toString());
				return params;
			}
